...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "con_so_chu_dao_cua_ban_la" : MessageLookupByLibrary.simpleMessage("您的命运数字"),
    ...
    "hay_chon_ngay_sinh_cua_ban" : MessageLookupByLibrary.simpleMessage("请选择您的出生日期"),
    "home" : MessageLookupByLibrary.simpleMessage("家"),
    "introl_1" : MessageLookupByLibrary.simpleMessage("命理学是根据您的姓名和出生日期来全面预测您的。通过命理学,您可以了解重要数字对您的生活有何影响。"),
    "introl_2" : MessageLookupByLibrary.simpleMessage("该应用程序将分析您的姓名和生日,以眨眼即可显示结果！了解出生数字或生命线（表达您的性格和生活观）。让我们看看这些数字怎么说你"),
    ...
    "y_nghia_cac_con_so_tren_bieu_do" : MessageLookupByLibrary.simpleMessage("说明图表的编号")
  };
}
